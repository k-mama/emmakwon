...
export const houseIndex = {
  ...
  supporting:
    "Music, books, story worlds, and English learning — four public rooms under the same roof.",
  feature: {
  ...
  rooms: [
    ...
    },
    {
      ...
      name: "K-MAMA",
      href: "/k-mama/",
      descriptor: "Learning English in Brisbane, one confusing point at a time.",
    },
    {
